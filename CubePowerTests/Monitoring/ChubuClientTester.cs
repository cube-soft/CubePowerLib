/* ------------------------------------------------------------------------- */
///
/// Monitoring/ChubuClientTester.cs
///
...
namespace CubePowerTests.Monitoring
{
    ...
    /* --------------------------------------------------------------------- */
    [TestFixture]
    public class ChubuClientTester
    {
        /* ----------------------------------------------------------------- */
        ///
        /// TestFromFile
        ...
        public void TestFromFile()
        {
            try
            {
                ...
                Assert.AreEqual(2099, response.Capacity);
                Assert.AreEqual(1328, response.Usage);
                ...
                Assert.AreEqual("万kW", response.Unit);
                Assert.AreEqual(2099, response.Capacity);
                Assert.AreEqual(1731, response.Usage);
                Assert.AreEqual(82, response.UsageRatio);
